...
export const useRoleRequest = () => {
    ...
    const submitRequest = async (requestedRole) => {
        setIsLoading(true)
        setError('')
        const response = await fetch(`http://197.26.204.208:3000/User/request/`, {
            method: 'POST',
            headers: {
    ...
    const checkRequest = async ()=> {
        setFetching(true);
        const response = await fetch(`http://197.26.204.208:3000/User/check-request`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const fetchRequests = async ()=> {
        setIsLoading(true);
        const response = await fetch(`http://197.26.204.208:3000/User/requests`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const acceptRequest = async (request)=> {
        setFetching(true);
        const response = await fetch(`http://197.26.204.208:3000/User/accept`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const rejectRequest = async (request)=> {
        setFetching(true);
        const response = await fetch(`http://197.26.204.208:3000/User/reject`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token')}`
