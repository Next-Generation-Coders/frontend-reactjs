...
const MatchesPanel = ( { selectedTournamentId }) => {
    ...
    useEffect(() => {
        const fetchTournament = async () => {
            try {
                const tournamentData = await fetch(`http://197.26.204.208:3000/Tournament/getbyid/${selectedTournamentId}`);
    ...
    //http://197.26.204.208:3000/Tournament/getMatchesFromGroupsWithMatches
    useEffect(() => {
        const fetchMatchesForLeague = async () => {
            try {
                const response = await fetch(`http://197.26.204.208:3000/Tournament/fixtures/${tournament._id}`);
                if (!response.ok) {
        ...
        const fetchMatchesForKnockout = async () => {
            try {
                const response = await fetch(`http://197.26.204.208:3000/Tournament/getFixturesKnockout/${tournament._id}`);
                if (!response.ok) {
