...
*/}
  ...
  const handleConfirmation = async () => {
    try {
      ...
      const response = await axios.post('http://197.26.204.208:3000/Payment/createPayment', formData);
      ...
      if (addressesMatch && payment) {
        await axios.put(`http://197.26.204.208:3000/Payment/${payment._id}`, { payment_status: 'paid' });
        toast.success("Your payment has been processed successfully!");
