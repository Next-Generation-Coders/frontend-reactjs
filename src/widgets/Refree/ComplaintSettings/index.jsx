...
import Profile from '@widgets/Refree/ComplaintSettings/Profile';
            ...
            <div className="d-flex flex-column justify-content-between flex-1">
                <Tabs value={activeTab}>
                    <TabsList className={`${styles.tabs_list} tab-nav col-2`}>
                        <TabButton title={width >= 375 ? 'Basic Complaint' : 'Profile'}
                                   onClick={() => setActiveTab('profile')}
                                   active={activeTab === 'profile'}/>
                        <TabButton title={width >= 375 ? 'Edit Complaint ' : 'Basic'}
